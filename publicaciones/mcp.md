...
El "Model Context Protocol" (`MCP`) es como el puerto USB de la inteligencia artificial. Se trata de un estándar abierto, creado por Anthropic (Amazon), que permite a las inteligencias artificiales más avanzadas, como ChatGPT, Gemini o Claude, **conectarse e interactuar directamente con herramientas y datos externos**, como bases de datos de una empresa, hojas de cálculo, sistemas de gestión de clientes (CRM) o plataformas de anuncios. Es similar al XML y JSON pero adecuado para las nuevas plataformas. Si quieres repasar antes otros términos básicos, puedes consultar nuestra [guía de conceptos de inteligencia artificial](https://emirodgar.es/guia-conceptos-basicos-inteligencia-artificial).

Inicialmente, las inteligencias artificiales generativas se limitaban a producir  texto. Con MCP, pueden ir mucho más allá: pueden acceder a información en tiempo real (por ejemplo, el stock de un producto), realizar acciones (comprar algo, enviar un email, crear una tarea) y automatizar flujos de trabajo complejos. Esto es vital para poder trabajar con [Agentes de IA](https://emirodgar.es/agentes-de-ia).
...
Estas capacidades ya se aplican en tareas muy concretas, como el [scraping inteligente apoyado en servidores MCP](https://emirodgar.es/scraping-ia) o la selección de las [herramientas de IA más útiles para empresas](https://emirodgar.es/herramientas-ia-empresas).
